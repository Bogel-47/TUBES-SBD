...
DELETE FROM REPORT WHERE REPORT_ID = 3;

DELETE FROM TRANS WHERE TRANS_ID = 2;
...
BEGIN
    SIGN_UP_EMPLOYEE ('Marcell','Ivaldri','MIVA','MIVA123','1','0')
END;

select * from EMPLOYEE where first_name = 'Marcell'

BEGIN
    SIGN_UP_EMPLOYEE ('Linda','Damayanti','DAMA','DAMA123','0','1')
END;

select * from EMPLOYEE where first_name = 'Linda'
...
BEGIN
  BOOKING_ROOM (01,'6/03/2020','9/03/2020',1,2,0,01,02);
END;
