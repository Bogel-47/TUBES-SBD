...
CREATE TABLE room (
    ...
    booking_booking_id1  INTEGER NOT NULL
);
...
ALTER TABLE trans ADD CONSTRAINT transaction_pk PRIMARY KEY ( trans_id );
...
ALTER TABLE room
    ADD CONSTRAINT room_booking_fk FOREIGN KEY ( booking_booking_id1 )
        REFERENCES booking ( booking_id );
